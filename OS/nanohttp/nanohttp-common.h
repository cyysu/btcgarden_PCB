...
#define MAX_HEADER_SIZE 1024//4256
#define MAX_SOCKET_BUFFER_SIZE  2048//4256
#define MAX_FILE_BUFFER_SIZE  1024//4256
...
#else
#define system_sleep(seconds) rt_thread_delay(RT_TICK_PER_SECOND*(seconds));
#endif
